...
public let tko2018Conferences: [Conference] = [
{
    ...
    trySwift.conferenceDescriptionJP = "try! Swift は、Swift におけるベストプラクティス、アプリ開発、サーバーサイド Swift、オープンソース Swift、そして Swift のコミュニティなど、プログラミング言語 Swift に関するコミュニティ主催のカンファレンスです。今年も東京で開催し、 3月1日、2日にエキスパートによるトーク、3日にピアラボ（もくもく会）、ワークショップ</strong>を行います。"
"
