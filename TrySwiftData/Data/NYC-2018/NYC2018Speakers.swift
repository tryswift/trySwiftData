...
public let nyc2018Speakers: [String : Speaker] = [
    ...
    "berta" : Speaker(
        ...
        bio: "Berta is an iOS developer @Novoda, swift ❤️ and director of Women Who Code Barcelona. She loves learning how things work, clean architecture, using technology to build ideas 🤖 and good ☕️."
    ),
    ...
    "cate" : Speaker(
        ...
        bio: "Cate has spent her career working on mobile and documenting everything she learns using WordPress. Now she combines the two as Automattic’s mobile lead. You can find her on Twitter at @catehstn and at cate.blog."
    ),
