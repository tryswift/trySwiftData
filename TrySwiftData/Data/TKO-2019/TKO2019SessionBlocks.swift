...
public let tko2019SessionBlocks: [SessionBlock] = [
    ...
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 21, hour: 10, minute: 30, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 10, minute: 55, second: 0),
    ...
    SessionBlock(
        ...
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 11, minute: 25, second: 0),
    ...
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 21, hour: 12, minute: 0, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 12, minute: 25, second: 0),
    ...
    SessionBlock(
        ...
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 13, minute: 55, second: 0),
        sessions : [tko2019Sessions["day1Lunch"]!]
    ),
    
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 21, hour: 14, minute: 0, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 14, minute: 25, second: 0),
    ...
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 21, hour: 15, minute: 0, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 15, minute: 25, second: 0),
    ...
    SessionBlock(
        ...
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 15, minute: 55, second: 0),
        sessions : [tko2019Sessions["day1Christina"]!,
                    tko2019Sessions["day1JTOfficeHours"]!]
    ),
    
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 21, hour: 16, minute: 0, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 16, minute: 25, second: 0),
        sessions : [tko2019Sessions["day1SecondCoffee"]!]
    ),
    
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 21, hour: 16, minute: 30, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 16, minute: 55, second: 0),
    ...
    SessionBlock(
        ...
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 17, minute: 25, second: 0),
        sessions : [tko2019Sessions["day1Jen"]!,
                    tko2019Sessions["day1AudreyOfficeHours"]!]
    ),
    
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 21, hour: 17, minute: 30, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 17, minute: 55, second: 0),
    ...
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 21, hour: 19, minute: 0, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 21, hour: 21, minute: 0, second: 0),
    ...
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 22, hour: 10, minute: 30, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 10, minute: 55, second: 0),
    ...
    SessionBlock(
        ...
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 11, minute: 25, second: 0),
    ...
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 22, hour: 12, minute: 0, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 12, minute: 25, second: 0),
    ...
    SessionBlock(
        ...
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 13, minute: 55, second: 0),
        sessions : [tko2019Sessions["day2Lunch"]!]
    ),
    
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 22, hour: 14, minute: 0, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 14, minute: 25, second: 0),
    ...
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 22, hour: 15, minute: 0, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 15, minute: 25, second: 0),
    ...
    SessionBlock(
        ...
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 15, minute: 55, second: 0),
        sessions : [tko2019Sessions["day2Erica"]!,
                    tko2019Sessions["day2KayaOfficeHours"]!]
    ),
    
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 22, hour: 16, minute: 0, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 16, minute: 25, second: 0),
        sessions : [tko2019Sessions["day2SecondCoffee"]!]
    ),
    
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 22, hour: 16, minute: 30, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 16, minute: 55, second: 0),
    ...
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 22, hour: 17, minute: 15, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 17, minute: 40, second: 0),
        sessions : [tko2019Sessions["day2Ddate"]!,
                    tko2019Sessions["day2MatttOfficeHours"]!]
    ),
    
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 22, hour: 17, minute: 45, second: 0),
        endTime : Date.date(year: 2019, month: 3, day: 22, hour: 18, minute: 10, second: 0),
        sessions : [tko2019Sessions["day2Alicia"]!,
                    tko2019Sessions["day2DdateOfficeHours"]!]
    ),
    
    SessionBlock(
        startTime : Date.date(year: 2019, month: 3, day: 22, hour: 18, minute: 15, second: 0),
