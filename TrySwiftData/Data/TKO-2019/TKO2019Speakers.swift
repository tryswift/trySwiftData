...
public let tko2019Speakers: [String : Speaker] = [
    ...
    "tarunon" : Speaker(
        ...
        bioJP: "tarunonです。MercariのiOSエンジニアです。料理とゲームとプログラミングが好きです。スマブラSPの発売日前にSplatoonのアップデートを試してしまったので、ゲームをやる時間が2倍になってしまいました。大変です。"
    ),
    ...
    "yuta_saito" : Speaker(
        ...
        bioJP: "株式会社メルカリのiOSインターンです。型による綺麗な世界を求めて日々Swiftと戯れています。最近はSwiftコンパイラを読むのが趣味です。"
    ),
    ...
    "yoshimura_hikaru" : Speaker(
        ...
        bioJP: "普段、Scalaのエンジニアをしていますが大学時代は型システムの研究をしていて、いくつかの関数型プログラム言語をちょっと書くことができます。ScalaやHaskell、OCamlといったプログラム言語のよいエッセンスをSwiftにもってくる活動を時々やっています。"
    ...
    "jon_tait_beason" : Speaker(
        ...
        bioJP: "Jon-Tait Beasonは、The 3D Laser Printerの製造元であるGlowforgeのiOSソフトウェアエンジニアです。彼は教育のバックグラウンドを持ち、教えることや学ぶことを楽しんでいます。なので、彼は他人から学んだり、初心者エンジニアを助けるiOSコミュニティによく出没しています。"
    ),
    ...
    "nic_laughter" : Speaker(
        ...
        bioJP: "Nic Laughterは現在ユタ州に住んでいる技術好きです。彼は2015年からコードを書いていて、現在はJane.comでソフトウェアエンジニアのゼネラリストとして働いています。主にメインのiOSアプリを開発し、時折WebサイトとReact Native製のセールスアプリにコントリビュートしています。時々Mediumにブログを書いていて、暇な時には音楽を作ったり、ビデオゲームをしたり、家族でのんびり過ごしています。"
    ),
    ...
    "benedikt_terhechte" : Speaker(
        ...
        bioJP: "Benediktは、プロ向け求人サイトのXINGでシニアiOS開発者として働いています。以前の仕事で、DisneyやDaimler-Chryslerなどの顧客向けのソリューションを開発しました。 インディーズMac開発者として、PhotoDeskやHirundoなどの成功したアプリを立ち上げました。2014年のSwiftリリース直後に調査を開始し、それについて書いた記事は人気があります。また、Core ValueとSourceKittenDaemonというオープンソースプロジェクトを始めました"
    ),
    ...
    "namrata_bandekar" : Speaker(
        ...
        bioJP: "NamrataはZyngaの中毒性のあるゲームを開発するプリンシパルソフトウェアエンジニアです。また、Ray Wenderlich Tutorial Teamのメンバーです。彼女は『ARKit by Tutorials』の共同執筆者であり、Android Apprentice本のTech Editorsの1人です。アプリを作る以外に、彼女は旅行、スキューバダイビング、​​犬とのハイキングに情熱を注いでいます。"
    ),
    ...
    "liz_marley" : Speaker(
        ...
        bioJP: "LizはOmni Groupの13年間のベテランで、現在はNordstromのiOSエンジニアです。また、シアトルで女性のためのApp Campを数回開催しています。彼女はカンファレンスで新しいことを学び、他のmacOSやiOSの開発者との付き合いをする言い訳としてトークをよくします。ちなみに、彼女は本を書いたり、Podcastをホストしたことはありません。"
    ),
    ...
    "sally_shepard" : Speaker(
        ...
        bioJP: "Sally Shepardは、iOS開発者、アクセシビリティコンサルタント、ライター、そしてハードウェアハッカーでもあります。色々な賞を獲得した多くのアプリケーションに携わってきました。iPhoneが発売される前は、彼女が好きな音楽と機械いじり掛け合わせた領域である音響技術を学んでいました。現在はロンドンに住んでおり、余暇に、あらゆる弦楽器を弾いたり、猫にセンサーをつけたり、ビンテージカメラで写真を撮ったりしています。"
    ),
    ...
    "krstnfx" : Speaker(
        ...
        bioJP: "Kristina FoxはIntuitのシニアiOSエンジニアです。kristina.ioでiOSやwatchOSのチュートリアルを書いたり、技術コメンテーターをしています。国際スピーカーとして、Apple Watch開発からエンジニアリングスキルを伸ばすための技術ライティングまで、幅広い内容で講演しています。過去にはAltConfやNSSpain、iOSDevUKなどのイベントで登壇しています。彼女の人生の目標はアボガドトーストをできるだけたくさん食べることです。猫の動画をみたり、Twitterをすることも楽しんでいます。Twitterは @krstnfx です。"
    ),
    ...
    "andrew" : Speaker(
        ...
        bioJP: "AndrewはLambdaスクールのiOSプログラムのディレクターです。この14年間、クリエイティブな人たちにむけて、特に音楽や動画のアプリを作成するなど、Cocoa開発を行ってきました。この3年、フルタイムのiOSの先生として、新人プログラマーにSwiftやiOSの素晴らしい世界を伝えています。iPhreaks iOS developmentというpodcastを共催していたり、開発者コミュニティを楽しんでいます。2014年からSwiftを始めましたが、Objective-Cは常に彼の初恋です。"
    ),
    ...
    "Ilseman" : Speaker(
        ...
        bioJP: "MichaelはAppleのSwift's Standard Libraryチームで働いています"
    ),
