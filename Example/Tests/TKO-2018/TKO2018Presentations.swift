...
public let tko2018Presentations: [String : Presentation] = [
    ...
    "sil" : {
        let presentation = Presentation()
        presentation.id = 2
        presentation.title = "⚡️🎤 SIL for First Time Learners"
        presentation.titleJP = "⚡️🎤 SIL入門"
    ...
    "diamond" : {
        let presentation = Presentation()
        presentation.id = 8
        presentation.title = "⚡️🎤 The diamond of variance"
        presentation.titleJP = "⚡️🎤 変性のダイヤモンド"
    ...
    "home" : {
        let presentation = Presentation()
        presentation.id = 10
        presentation.title = "⚡️🎤 Swift in my home"
        presentation.titleJP = "⚡️🎤 我が家を支えるSwiftの技術"
    ...
    "webapi" : {
        let presentation = Presentation()
        presentation.id = 13
        presentation.title = "⚡️🎤 Protocol Oriented WebAPI Abstraction"
        presentation.titleJP = "⚡️🎤 Protocol Oriented WebAPI Abstraction"
    ...
    "peerlabs" : {
        let presentation = Presentation()
        presentation.id = 17
        presentation.title = "⚡️🎤 Swift Peer Lab Barcelona"
        presentation.titleJP = "⚡️🎤 Swift もくもく会 in Barcelona"
    ...
    "coreml" : {
        let presentation = Presentation()
        presentation.id = 20
        presentation.title = "⚡️🎤 Super Resolution with CoreML"
        presentation.titleJP = "⚡️🎤 超解像+CoreML+Swiftを使ってアプリの画像データ転送量削減に挑戦する"
    ...
    "swift5" : {
        let presentation = Presentation()
        presentation.id = 24
        presentation.title = "⚡️🎤 Preparing for Swift 5 Ownership"
        presentation.titleJP = "⚡️🎤 Swift5のOwnershipに備える"
    ...
    "codable" : {
        let presentation = Presentation()
        presentation.id = 26
        presentation.title = "⚡️🎤 The Type-Safe World of Codable"
        presentation.titleJP = "⚡️🎤 Codableが導く型安全な世界"
    ...
    "docker" : {
        let presentation = Presentation()
        presentation.id = 29
        presentation.title = "⚡️🎤 Best Docker Container in Swift"
        presentation.titleJP = "⚡️🎤 Swiftが動くDockerコンテナの各OSの性能比較"
    ...
    "typeerasure" : {
        let presentation = Presentation()
        presentation.id = 30
        presentation.title = "⚡️🎤 The Type Erasure Advantage"
        presentation.titleJP = "⚡️🎤 型とパフォーマンスで見るType-erasureの利点"
