...
public let nyc2016Speakers: [String : Speaker] = [
    "ellen" : { let ellen = Speaker()
        ellen.id = 1
        ellen.name = "Ellen Shapiro"
        ellen.twitter = "designatednerd"
        ellen.imageAssetName = "ellen_shapiro"
    ...
    "marc": { let marc = Speaker()
        marc.id = 2
        marc.name = "Marc Brown"
        marc.twitter = "heymarcbrown"
        marc.imageAssetName = "marc_brown"
    ...
    "dani" : { let dani = Speaker()
        dani.id = 4
        dani.name = "Danielle Tomlinson"
        dani.twitter = "dantoml"
        dani.imageAssetName = "daniel_tomlinson"
    ...
    "natalia": { let natalia = Speaker()
        natalia.id = 5
        natalia.name = "Natalia Berdys"
        natalia.twitter = "batalia"
        natalia.imageAssetName = "natalia_berdys"
    ...
    "andyy" : { let andyy = Speaker()
        andyy.id = 6
        andyy.name = "Andyy Hope"
        andyy.twitter = "AndyyHope"
        andyy.imageAssetName = "andyy_hope"
    ...
    "kristina" : { let kristina = Speaker()
        kristina.id = 7
        kristina.name = "Kristina Thai"
        kristina.twitter = "kristinathai"
        kristina.imageAssetName = "kristina_thai"
    ...
    "jorge" : { let jorge = Speaker()
        jorge.id = 8
        jorge.name = "Jorge Ortiz"
        jorge.twitter = "jdortiz"
        jorge.imageAssetName = "jorge_ortiz"
    ...
    "vixentael" : { let vixentael = Speaker()
        vixentael.id = 9
        vixentael.name = "Anastasiia Voitova"
        vixentael.twitter = "vixentael"
        vixentael.imageAssetName = "anastasiia_voitova"
    ...
    "anat" : { let anat = Speaker()
        anat.id = 10
        anat.name = "Anat Gilboa"
        anat.twitter = "anat_gilboa"
        anat.imageAssetName = "anat_gilboa"
    ...
    "sam" : { let sam = Speaker()
        ...
        sam.imageAssetName = "samuel_giddins"
    ...
    "hector" : { let hector = Speaker()
        hector.id = 13
        hector.name = "Hector Matos"
        hector.twitter = "allonsykraken"
        hector.imageAssetName = "hector_matos"
    ...
    "daniel" : { let daniel = Speaker()
        daniel.id = 15
        daniel.name = "Daniel Jalkut"
        daniel.twitter = "danielpunkass"
        daniel.imageAssetName = "daniel_jalkut"
    ...
    "bojana" : { let bojana = Speaker()
        bojana.id = 16
        bojana.name = "Bojana Jam"
        bojana.twitter = "bojanajam"
        bojana.imageAssetName = "bojana_jam"
    ...
    "saul" : { let saul = Speaker()
        saul.id = 17
        saul.name = "Saul Mora"
        saul.twitter = "casademora"
        saul.imageAssetName = "saul_mora"
    ...
    "marin" : { let marin = Speaker()
        marin.id = 18
        marin.name = "Marin Todorov"
        marin.twitter = "icanzilb"
        marin.imageAssetName = "marin_todorov"
    ...
    "natasha" : { let natasha = Speaker()
        natasha.id = 19
        natasha.name = "Natasha Nazari"
        natasha.twitter = "natasha_nazari"
        natasha.imageAssetName = "natasha_nazari"
    ...
    "erik" : { let erik = Speaker()
        erik.id = 20
        erik.name = "Erik Romijn"
        erik.twitter = "erikpub"
        erik.imageAssetName = "erik_romijn"
    ...
    "ryan" : { let ryan = Speaker()
        ryan.id = 21
        ryan.name = "Ryan Nystrom"
        ryan.twitter = "_ryannystrom"
        ryan.imageAssetName = "ryan_nystrom"
    ...
    "chrisBailey" : { let chrisBailey = Speaker()
        chrisBailey.id = 22
        chrisBailey.name = "Chris Bailey"
        chrisBailey.twitter = "Chris__Bailey"
        chrisBailey.imageAssetName = "chris_bailey"
    ...
    "katsumi" : { let katsumi = Speaker()
        katsumi.id = 23
        katsumi.name = "Katsumi Kishikawa"
        katsumi.twitter = "k_katsumi"
        katsumi.imageAssetName = "katsumi_kishikawa"
    ...
    "cate" : { let cate = Speaker()
        cate.id = 24
        cate.name = "Cate Huston"
        cate.twitter = "catehstn"
        cate.imageAssetName = "cate_huston"
    ...
    "chrisBritt" : {
        ...
        chrisBritt.imageAssetName = "chris_britt"
    ...
    "chrisRobert" : {
        ...
        chrisRobert.imageAssetName = "chris_robert"
