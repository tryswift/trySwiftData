...
public let nyc2016ConferenceDays: [ConferenceDay] = [
    {
        ...
        for index in 0...1 {
            day1.sessionBlocks.append(nyc2016SessionBlocks[index])
        }
        return day1
    }(),
    {
        ...
        for index in 2...19 {
            day2.sessionBlocks.append(nyc2016SessionBlocks[index])
        }
        return day2
    }(),
    {
        ...
        for index in 20...37 {
            day3.sessionBlocks.append(nyc2016SessionBlocks[index])
        }
        return day3
    }()
]
