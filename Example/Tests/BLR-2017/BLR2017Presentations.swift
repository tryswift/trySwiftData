...
public let blr2017Presentations: [String : Presentation] = [
    ...
    "jono" : {
        ...
        presentation.speaker = blr2017Speakers["jono"]
        return presentation
    }(),
    ...
    "sreeram" : {
        ...
        presentation.speaker = blr2017Speakers["sreeram"]
        return presentation
    }(),
    ...
    "mamtha" : {
        ...
        presentation.speaker = blr2017Speakers["mamtha"]
        return presentation
    }(),
    ...
    "mugunth" : {
        ...
        presentation.speaker = blr2017Speakers["mugunth"]
        return presentation
    }(),
    ...
    "cate" : {
        ...
        presentation.speaker = blr2017Speakers["cate"]
        return presentation
    }(),
    ...
    "kamilah" : {
        ...
        presentation.speaker = blr2017Speakers["kamilah"]
        return presentation
    }(),
    ...
    "vatsal" : {
        ...
        presentation.speaker = blr2017Speakers["vatsal"]
        return presentation
    }(),
    ...
    "shivam" : {
        ...
        presentation.speaker = blr2017Speakers["shivam"]
        return presentation
    }(),
    ...
    "robin" : {
        ...
        presentation.speaker = blr2017Speakers["robin"]
        return presentation
    }(),
    ...
    "bhargav" : {
        ...
        presentation.speaker = blr2017Speakers["bhargav"]
        return presentation
    }(),
    ...
    "jesse" : {
        ...
        presentation.speaker = blr2017Speakers["jesse"]
        return presentation
    }(),
    ...
    "akanksha" : {
        let presentation = Presentation()
        presentation.id = 15
        presentation.title = "AI & Deep Learning using Core ML and Metal Framework"
        presentation.summary = "Until now, Artificial Intelligence was a term associated with high-end GPUs and cloud-based APIs. CoreML and Metal Kit in iOS 11, introduced Swift APIs to implement neural networks into mobile devices. This talk is about how we integrated these APIs to implement and run Deep Learning into our app. With the help of these Swift APIs, we built Entities Recognition mechanism to automatically extract specific details out of videos. I will also discuss the technical challenges in implementing AI architecture and the importance of Swift in achieving this goal."
        presentation.speaker = blr2017Speakers["akanksha"]
        return presentation
    }()
]
